                            ...
                            <table class="table table-bordered table-hover" id="tab_logic">
                                ...
                                <tbody>
                                    <tr id='addr0'>
                                        ...
                                        <td>
                                            <input type="checkbox" name='isActive[]' id="isActive_0" value='1'/>
                                        </td>
                                        <td>
                                            <div class="form-group">                   
